                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <label className="h5">Agregar Proveedor</label>
                        </div>
                        <div className="modal-body">
                            <Campo id="nombre" iconName="fa-solid fa-user" inputType="text" placeHolder="Nombre" />
                            <Campo id="apellido" iconName="fa-solid fa-user-tag" inputType="text" placeHolder="Apellido" />
                            <Campo id="telefono" iconName="fa-solid fa-phone" inputType="number" placeHolder="Teléfono" />
